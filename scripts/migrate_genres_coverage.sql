...
INSERT IGNORE INTO `osap-storage`.genre_mappings (code, genre_id) VALUES
...
INSERT IGNORE INTO `osap-storage`.genre_mappings (code, genre_id)
SELECT DISTINCT w.genre, base.genre_id
FROM `osap-storage_v1`.works w
JOIN `osap-storage`.genre_mappings base ON base.code = SUBSTRING_INDEX(w.genre, '-', 1)
